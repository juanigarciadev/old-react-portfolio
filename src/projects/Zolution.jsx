    ...
    <section className="flex flex-col w-screen py-64 px-16 gap-4">
      ...
      <div className="flex flex-col gap-2 my-32 pl-[25%] lg:pl-0">
        ...
        <p className="text-neutral-400 w-8/12 lg:w-full">
          ...
          mode and login functionalities. It still has the original design that
          I did in its day but probably at some point of boredom I will make a
          second version updating everything with my knowledge of the moment.
        </p>
      </div>
