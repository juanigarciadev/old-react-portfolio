  ...
  return (
    <footer className="flex flex-col w-full">
      <section className="flex flex-col pb-16 md:pb-12">
        ...
        <h2 className="text-title font-bold pb-1.5 px-16">Contact Me</h2>
      </section>
      <div className="flex justify-between px-16 pb-24 h-auto gap-32 md:flex-col md:gap-8">
        <section className="flex gap-32 md:flex-col md:gap-8">
          <section>
          ...
          <section>
            ...
            <h2 className="text-subtitle font-bold">+(54) 9 261 597-1527</h2>
          </section>
        </section>
        <section className="flex gap-20 justify-bottom items-center lg:gap-4 md:gap-16">
          <BsGithub
